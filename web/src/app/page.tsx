...
import { ExternalLink, ArrowRight, Mail, Github, Linkedin, MapPin, Code2, Sparkles, GraduationCap } from "lucide-react";
    ...
    <div className="space-y-16">
      ...
      <section id="projects" className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-muted-foreground max-w-2xl">Real, production-oriented work with a focus on clean UI, performance, and maintainable code. Filter by stack to jump to what interests you.</p>
        </div>
        <ProjectsClient projects={projects} />
      </section>

      <section id="contact" className="grid gap-6 md:grid-cols-5">
        <div
